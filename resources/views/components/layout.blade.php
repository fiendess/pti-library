...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/flowbite@3.0.0/dist/flowbite.min.css" 
    rel="stylesheet" />
    <title>Home</title>
</head>
<body class="h-full">
      ...
      navigator.geolocation.getCurrentPosition(
        async function (position) {
          ...
          try {
            ...
            provinceElement.textContent = "Error";
            countryElement.textContent = "Unable to fetch location";
          }
        },
        function (error) {
          console.error("Geolocation error:", error);
          provinceElement.textContent = "Permission denied";
          countryElement.textContent = "Please enable location services";
        }
      );
    } else {
      provinceElement.textContent = "Geolocation not supported";
      countryElement.textContent = "";
    }
  });
</script>
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBiSRGSp74RDmzNbf9fJUGzg6iNOu8oVQA&libraries=places,geometry&callback=initMap"></script>
